...
class Map
{
  ...
  public:
    ...
    int MapBefore;									//id of the map before switching to the current map
    int Successor;									//id of the successor
    int Predecessor;
    TooN::SO3<> Rotation_i;							//Initial rotation of this map w.r.t. reference frame
    TooN::Vector<3> Translation_i;							//Initial translation w.r.t. reference frame
    bool IsNewPoseSet;
    TooN::SO3<> Rotation_middle;					//Additional Rotation Step
    TooN::Vector<3> Translation_middle;				//Additional transalation step;
